...
namespace QuantConnect
{
    ...
    public sealed class Symbol : IEquatable<Symbol>, IComparable
    {
        ...
        public static implicit operator Symbol(string ticker)
        {
            ...
            Log.Error($"The string '{ticker}' was used as a symbol, but could not be converted into a symbol object. " +
                      $"Ensure the symbol you are trying to use has been registered using the AddSecurity() function");
